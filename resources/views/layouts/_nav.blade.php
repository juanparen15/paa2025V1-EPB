<aside class="main-sidebar sidebar-dark-blue elevation-4">
    ...
    <a href="{{ route('home') }}" class="brand-link">
        <img src="{!! asset('adminlte/dist/img/AdminLTELogo.jpg') !!}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
            style="opacity: .8">
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            ...
            ">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.acta.index') }}"
                            class="nav-link 
            {!! active_class(route('admin.acta.index')) !!}
            ">
                            <i class="nav-icon fas fa-list-ul"></i>
                            <p>
                                Actas
            ...
            ">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.estadovigencias.index') }}"
                            class="nav-link 
            ...
            ">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.meses.index') }}"
                            class="nav-link 
            ...
            ">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.tipoadquicsiciones.index') }}"
                            class="nav-link 
            ...
            ">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.tipoadquicsiciones55.index') }}"
                            class="nav-link 
            ...
            ">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.tipoprocesos.index') }}"
                            class="nav-link 
            ...
            ">
                    ...
                    {{-- <li class="nav-item">
                        <a href="{{ route('admin.vigencias_pasadas.index') }}"
                            class="nav-link 
            {!! active_class(route('admin.vigencias_pasadas.index')) !!}
            ">
                            <i class="nav-icon far fa-calendar-check"></i>
                            <p>
                                Vigencias Pasadas
