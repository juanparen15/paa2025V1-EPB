            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                     ...
                     <a href="{{route('admin.acta.create')}}" class="btn btn-primary">
                        Agregar Acta
                     </a>
                  </div>
                </div>
                    ...
                    <tbody>
                     ...
                     <tr>
                       ...
                       <td class="project-actions text-right">
                           <form action="{{route('admin.acta.destroy',$acta)}}" method="POST">
                              @csrf
                               @method('delete')

                               <a class="btn btn-primary btn-sm" href="{{route('admin.acta.edit', $acta)}}">Editar</a>
