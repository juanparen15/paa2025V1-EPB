    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="form-group">
                <form action="{{route('dependencias.import.excel')}}" method="POST" enctype="multipart/form-data">
                    @csrf

                    <input type="file" name="file" required>
                    <button class="btn btn-primary float-right">Importar dependencias</button>
                </form>
            </div>
