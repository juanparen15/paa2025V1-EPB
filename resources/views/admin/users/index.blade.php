                                    ...
                                    <tr>
                                        ...
                                        <td class="project-actions text-right">
                                            ...
                                            <form method="POST" action="{{ route('users.destroy', $user) }}"
                                                id="delete_form_{{ $user->id }}" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-danger btn-sm"
                                                    onclick="enviar_formulario({{ $user->id }})">
...
@section('script')
    ...
    @endif
    <script>
        function enviar_formulario(userId) {
            Swal.fire({
                title: '¿Estás seguro?',
                ...
                if (result.isConfirmed) {
                    // Enviar el formulario correspondiente al usuario
