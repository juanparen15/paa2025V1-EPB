            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="areas_id">Dependencia o Área:</label>
                                <select class="form-control custom-select @error('areas_id') is-invalid @enderror"
                                    name="areas_id" id="areas_id" style="width: 100%;">
