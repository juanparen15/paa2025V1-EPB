...
@section('title','Editar la Fuente')
@section('style')
<!-- Select2 -->
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="{{route('admin.fuentes.index')}}">Familias</a></li>
              <li class="breadcrumb-item active">Editar la Fuente</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
