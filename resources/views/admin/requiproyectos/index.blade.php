...
@section('title','Requiere proyecto')
@section('style')
<!-- SweetAlert2 -->
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    {{--  <h1 class="m-0">Requiere proyecto del sistema</h1>  --}}
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-body table-responsive">
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                       <td>{{$requiproyecto->id}}</td>
                       <td>{{$requiproyecto->detproyeto}}</td>
                       <td >
                         
                          <form action="{{route('admin.proyectos.destroy',$requiproyecto)}}" method="POST">
                           @csrf
                            @method('delete')

                            <a class="btn btn-primary btn-sm" href="{{route('admin.proyectos.edit', $requiproyecto)}}">Editar</a>
