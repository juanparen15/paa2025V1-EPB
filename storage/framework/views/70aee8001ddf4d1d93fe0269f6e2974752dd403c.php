...
<?php $__env->startSection('title','Lista Tipo Proceso Contratual'); ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Lista Tipo Proceso Contratual</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Lista Tipo Proceso Contratual</h3>
                  <div class="card-tools">

                     <a href="<?php echo e(route('admin.tipoprocesos.create')); ?>" class="btn btn-primary">
                        Agregar Tipo Proceso Contratual
                     </a>
                  </div>
                </div>
                <!-- /.card-header -->
                  ...
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <?php $__currentLoopData = $tipoprocesos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoproceso): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                        <td><?php echo e($tipoproceso->id); ?></td>
                        <td><?php echo e($tipoproceso->dettipoproceso); ?></td>
                        
                        <td>
                              <form action="<?php echo e(route('admin.tipoprocesos.destroy',$tipoproceso)); ?>" method="POST">
                                 <?php echo csrf_field(); ?>
                                 <?php echo method_field('delete'); ?>

                                 <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.tipoprocesos.edit',$tipoproceso)); ?>">Editar</a>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'El Tipo Proceso se Actualizo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'El Tipo de Proceso se Creo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<script>
    Swal.fire(
        '¡Eliminado!',
        'El Tipo Proceso se Elimino con Exito.',
        'success'
      )
</script>
<?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\paa2022\resources\views/admin/tipoprocesos/index.blade.php ENDPATH**/ ?>