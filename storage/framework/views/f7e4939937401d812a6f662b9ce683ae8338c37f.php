...
<?php $__env->startSection('title','Lista de Fuentes'); ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Agregar Fuente</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                     ...
                     <a href="<?php echo e(route('admin.fuentes.create')); ?>" class="btn btn-primary">
                        Agregar Familia
                     </a>
                  </div>
                </div>
                ...
                <div class="card-body table-responsive">
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                        <td><?php echo e($fuente->id); ?></td>
                        <td><?php echo e($fuente->detfuente); ?></td>
                      
                        <td >
                           <form action="<?php echo e(route('admin.fuentes.destroy',$fuente)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                                 <?php echo method_field('delete'); ?>

                                 <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.fuentes.edit', $fuente)); ?>">Editar</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\paa2022\resources\views/admin/fuentes/index.blade.php ENDPATH**/ ?>