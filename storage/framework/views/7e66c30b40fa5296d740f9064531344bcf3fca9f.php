            ...
            <div class="container py-1">
                <div class="row align-items-center">
                    <div class="col-8 col-md-8 col-lg-4">
                        <h1 class="mb-0"><a href="<?php echo e(route('welcome')); ?>"
                                class="text-white h2 mb-0"><strong></strong></a></h1>
                    </div>
                                ...
                                <?php if(Route::has('login')): ?>
                                    ...
                                    <?php else: ?>
                                        <li><a class="btn btn-outline-primary" style="padding:5px"
                                                href="<?php echo e(route('login')); ?>">Iniciar Sesión</a></li>
...
<?php /**PATH C:\laragon\www\paa2022v1\resources\views/layouts/principal.blade.php ENDPATH**/ ?>