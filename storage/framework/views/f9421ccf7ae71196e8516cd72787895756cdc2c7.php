...
<?php $__env->startSection('title','Lista Tipo Prioridad'); ?>
            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                     ...
                     <a href="<?php echo e(route('admin.tipoprioridades.create')); ?>" class="btn btn-primary">
                  ...
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <?php $__currentLoopData = $tipoprioridades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipoprioridad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                           <td><?php echo e($tipoprioridad->id); ?></td>
                           <td><?php echo e($tipoprioridad->detprioridad); ?></td>
                           
                           <td >
                              <form action="<?php echo e(route('admin.tipoprioridades.destroy',$tipoprioridad)); ?>" method="POST">
                                 <?php echo csrf_field(); ?>
                                    <?php echo method_field('delete'); ?>

                                    <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.tipoprioridades.edit', $tipoprioridad)); ?>">Editar</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\paa2022\resources\views/admin/tipoprioridades/index.blade.php ENDPATH**/ ?>