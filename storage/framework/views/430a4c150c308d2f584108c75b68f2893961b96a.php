...
<?php $__env->startSection('title','Lista Familia'); ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Lista Familia</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Lista Familia</h3>
                  <div class="card-tools">

                     <a href="<?php echo e(route('admin.familias.create')); ?>" class="btn btn-primary">
                        Agregar Familia
                     </a>
                  </div>
                </div>
                  ...
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                       ...
                       <td><?php echo e($familia->detfamilia); ?></td>
                       <td><?php echo e($familia->segmento->detsegmento); ?></td>
                       
                       <td width="10px">
                           <form action="<?php echo e(route('admin.familias.destroy',$familia)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                               <?php echo method_field('delete'); ?>

                               <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.familias.edit', $familia)); ?>">Editar</a>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'La Familia se Actualizo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'La Familia se Creo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<script>
    Swal.fire(
        '¡Eliminado!',
        'La Familia se Elimino con Exito.',
        'success'
      )
</script>
<?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\plan-de-adquisiciones\resources\views/admin/familias/index.blade.php ENDPATH**/ ?>