...
<?php $__env->startSection('title','Lista de Estados Solicitud Vigencia'); ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Lista de Estados Solicitud Vigencia</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Lista de Estados Solicitud Vigencia</h3>
                  <div class="card-tools">

                     <a href="<?php echo e(route('admin.estadovigencias.create')); ?>" class="btn btn-primary">
                        Agregar Estado Solicitud Vigencia
                     </a>
                  </div>
                </div>
                <!-- /.card-header -->
                <div class="card-body table-responsive">
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                       <td><?php echo e($estadovigencia->id); ?></td>
                       <td><?php echo e($estadovigencia->detestadovigencia); ?></td>
                       <td class="project-actions text-right">
                           <form action="<?php echo e(route('admin.estadovigencias.destroy',$estadovigencia)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                               <?php echo method_field('delete'); ?>

                               <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.estadovigencias.edit', $estadovigencia)); ?>">Editar</a>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'El Estado Vigencia se Actualizo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'El Estado de la vigencia se Creo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<script>
    Swal.fire(
        '¡Eliminado!',
        'El Estado Vigencia se Elimino con Exito.',
        'success'
      )
</script>
<?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\paa2022\resources\views/admin/estadovigencias/index.blade.php ENDPATH**/ ?>