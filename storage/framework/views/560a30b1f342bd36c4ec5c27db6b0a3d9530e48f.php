...
<?php $__env->startSection('title','Lista Dependencias'); ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Lista Dependencias</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Lista Dependencias</h3>
                  <div class="card-tools">

                     <a href="<?php echo e(route('admin.dependencias.create')); ?>" class="btn btn-primary">
                        Agregar Dependencia
                     </a>
                  </div>
                </div>
                ...
                <div class="card-body table-responsive">
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                       <td><?php echo e($dependencia->id); ?></td>
                       <td><?php echo e($dependencia->nomdependencia); ?></td>
                       
                       <td class="project-actions text-right">
                           <form action="<?php echo e(route('admin.dependencias.destroy',$dependencia)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                               <?php echo method_field('delete'); ?>

                               <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.dependencias.edit', $dependencia)); ?>">Editar</a>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'La Dependencia se Actualizo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'La Dependencia se Creo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<script>
    Swal.fire(
        '¡Eliminado!',
        'La Dependencia se Elimino con Exito.',
        'success'
      )
</script>
<?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\paa2022\resources\views/admin/dependencias/index.blade.php ENDPATH**/ ?>