...
<?php $__env->startSection('title','Lista Areas'); ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Lista Areas</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Lista Areas</h3>
                  <div class="card-tools">

                     <a href="<?php echo e(route('admin.areas.create')); ?>" class="btn btn-primary">
                        Agregar Area
                     </a>
                  </div>
                </div>
                  ...
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                       ...
                       <td><?php echo e($area->nomarea); ?></td>
                       <td>
                           <?php if(isset( $area->dependencia->nomdependencia) ): ?>
                           <?php echo e($area->dependencia->nomdependencia); ?>
                       ...
                       <td class="project-actions text-right">
                          ...
                          <form action="<?php echo e(route('admin.areas.destroy',$area)); ?>" method="POST">
                           <?php echo csrf_field(); ?>
                            ...
                            <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.areas.edit', $area)); ?>">Editar</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\paa2022\resources\views/admin/areas/index.blade.php ENDPATH**/ ?>