...
<?php $__env->startSection('title','Lista de Modalidades'); ?>
            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                     ...
                     <a href="<?php echo e(route('admin.modalidades.create')); ?>" class="btn btn-primary">
                        Agregar Modalidad
                     </a>
                  </div>
                </div>
                ...
                <div class="card-body table-responsive">
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <?php $__currentLoopData = $modalidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modalidade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr>
                        <td><?php echo e($modalidade->id); ?></td>
                        <td><?php echo e($modalidade->detmodalidad); ?></td>
                        
                        <td width="10px">
                           <form action="<?php echo e(route('admin.modalidades.destroy',$modalidade)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                                 <?php echo method_field('delete'); ?>

                                 <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.modalidades.edit', $modalidade)); ?>">Editar</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\paa2022\resources\views/admin/modalidades/index.blade.php ENDPATH**/ ?>