...
<?php $__env->startSection('title','Lista Clase'); ?>
            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-tools">
                     ...
                     <a href="<?php echo e(route('admin.clases.create')); ?>" class="btn btn-primary">
                        Agregar Clase
                     </a>
                  </div>
                </div>
                  ...
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                       ...
                       <td><?php echo e($clase->detclase); ?></td>
                       <td><?php echo e($clase->familia->detfamilia); ?></td>
                      
                       <td class="project-actions text-right">
                           <form action="<?php echo e(route('admin.clases.destroy',$clase)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                               <?php echo method_field('delete'); ?>

                               <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.clases.edit', $clase)); ?>">Editar</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\plan-de-adquisiciones\resources\views/admin/clases/index.blade.php ENDPATH**/ ?>