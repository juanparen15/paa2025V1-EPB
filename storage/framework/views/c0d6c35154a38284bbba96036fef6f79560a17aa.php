...
<?php $__env->startSection('title','Requiere proyecto'); ?>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Requiere proyecto</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Requiere proyecto</h3>
                  <div class="card-tools">

                     <a href="<?php echo e(route('admin.proyectos.create')); ?>" class="btn btn-primary">
                        Agregar proyecto
                     </a>
                  </div>
                </div>
                ...
                <div class="card-body table-responsive">
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                       <td><?php echo e($requiproyecto->id); ?></td>
                       <td><?php echo e($requiproyecto->detproyeto); ?></td>
                       <td >
                         
                          <form action="<?php echo e(route('admin.proyectos.destroy',$requiproyecto)); ?>" method="POST">
                           <?php echo csrf_field(); ?>
                            <?php echo method_field('delete'); ?>

                            <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.proyectos.edit', $requiproyecto)); ?>">Editar</a>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'El Requerimiento de proyecto se Actualizo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'El requierimiento proyecto se Creo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<script>
    Swal.fire(
        '¡Eliminado!',
        'El Requwrimiento del Proyecto se Elimino con Exito.',
        'success'
      )
</script>
<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\paa2022\resources\views/admin/requiproyectos/index.blade.php ENDPATH**/ ?>