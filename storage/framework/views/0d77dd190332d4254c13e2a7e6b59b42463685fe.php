            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Lista Actas</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Lista Actas</h3>
                  <div class="card-tools">

                     <a href="<?php echo e(route('admin.acta.create')); ?>" class="btn btn-primary">
                        Agregar Acta
                     </a>
                  </div>
                </div>
                ...
                <div class="card-body table-responsive">
                  <table id="example2" class="table table-hover text-nowrap">
                    ...
                    <tbody>
                     ...
                     <tr>
                       <td><?php echo e($acta->id); ?></td>
                       <td><?php echo e($acta->det_acta); ?></td>
                       
                       <td class="project-actions text-right">
                           <form action="<?php echo e(route('admin.acta.destroy',$acta)); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                               <?php echo method_field('delete'); ?>

                               <a class="btn btn-primary btn-sm" href="<?php echo e(route('admin.acta.edit', $acta)); ?>">Editar</a>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'La acta se Actualizo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<script>
    $(function() {
        ...
        Toast.fire({
            icon: 'success',
            title: 'La acta se Creo con Exito.'
        })
      });
</script>
<?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\paa2022v1\resources\views/admin/acta/index.blade.php ENDPATH**/ ?>